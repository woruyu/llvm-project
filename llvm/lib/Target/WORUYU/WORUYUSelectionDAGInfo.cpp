//===-- WORUYUSelectionDAGInfo.cpp - WORUYU SelectionDAG Info -------------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file implements the WORUYUSelectionDAGInfo class.
//
//===----------------------------------------------------------------------===//
...
#define DEBUG_TYPE "WORUYU-selectiondag-info"

WORUYUSelectionDAGInfo::WORUYUSelectionDAGInfo()
    : SelectionDAGGenTargetInfo(WORUYUGenSDNodeInfo) {}

SDValue WORUYUSelectionDAGInfo::EmitTargetCodeForMemcpy(
  ...
  return DAG.getNode(WORUYUISD::MEMCPY, dl, MVT::Other, Chain, Dst, Src,
