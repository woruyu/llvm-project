//===-- WORUYUISelLowering.h - WORUYU DAG Lowering Interface ----------*- C++ -*-===//
//
...
public:
  explicit WORUYUTargetLowering(const TargetMachine &TM, const WORUYUSubtarget &STI);
...
private:
  ...
  // Lower a call into CALLSEQ_START - WORUYUISD:CALL - CALLSEQ_END chain
  ...
  // type Ty1 to type Ty2. e.g. On WORUYU at alu32 mode, it's free to truncate
